...
public class plunger : MonoBehaviour
{
    ...
    //public plungerVisual plungerVisual;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(key) && !launched)
            charging = true;
    ...
    void UpdateColliderCompression()
    {
        float newH = Mathf.Lerp(boxStartSize.y, boxStartSize.y * compressedHeightFactor, charge01);
        box.size = new Vector2(boxStartSize.x, newH);
        //plungerVisual.UpdateColliderCompression();
